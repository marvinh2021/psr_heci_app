...
namespace Heci {
    class Psr_command : public Heci_command {
...
//    protected:
        ...
        void random_byte_array(uint8_t arr[], int len);

    public:
        // PSR methods
        Psr_command() : Heci_command(Guid_id::PSR_HECI_DYNAMIC_CLIENT_GUID) {}   // Constructor
        ...
        Psr_status get_platform_service_record(Psr_heci_psr_get_response *psr_blob);
    };
}
